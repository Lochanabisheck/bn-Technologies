...
const resetSubmitButton = () => {
  ...
  submitButton.querySelector('span').textContent = 'Request appointment';
};
...
bookingForm.addEventListener('submit', async (event) => {
  ...
  const accessKey = bookingForm.querySelector('input[name="access_key"]').value.trim();
  if (!accessKey || accessKey === 'YOUR_WEB3FORMS_ACCESS_KEY') {
    formStatus.textContent = 'Add your Web3Forms access key before accepting appointments.';
    return;
  }
